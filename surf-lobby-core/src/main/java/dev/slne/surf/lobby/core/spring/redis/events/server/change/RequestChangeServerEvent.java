package dev.slne.surf.lobby.core.spring.redis.events.server.change;

import dev.slne.surf.lobby.core.spring.redis.events.LobbyRedisEvent;
import java.util.UUID;
import org.jetbrains.annotations.Contract;

public class RequestChangeServerEvent extends LobbyRedisEvent {

  public static final String CHANNEL = "surf:lobby:change-server";
  private UUID uuid;
